               ...
               <div class="col-xl-12 col-lg-7">
                 <div class="card shadow mb-4" style="min-height: 543px">
                   ...
                   <div class="card-header py-3 d-flex flex-row align-items-center justify-content-between">
                     <h6 class="m-0 font-weight-bold text-primary">กดเพื่อเข้าทำงาน</h6>
                   </div>
                   <!-- Card Body -->
                   <div class="card-body">
                     <?php if ($weekends == true) : ?>
                       <h1 class="text-center my-3">ขอบคุณสำหรับอาทิตย์นี้</h1>
                     ...
                     <?php else : ?>
                       <?php if ($in == false) : ?>
                         ...
                         <?= form_close() ?>
                       <?php else : ?>
                         <h3 class="text-center my-3">ขอบคุณสำหรับวันนี้</h3>
                         <h6 class="card-title text-center mb-4 px-4">ทำงานได้ยอดเยี่ยม </h6>
                         <?php if ($disable == false) : ?>
                           ...
                           <?php else : ?>
                             <b><p class="text-center text-primary pt-3">เจอกันวันพรุ่งนี้นะ</p></b>
                             <div class="row">
                               <button disabled class="btn btn-danger btn-circle mx-auto" style="font-size: 35px; width: 200px; height: 200px">
                                 <i class="fas fa-fw fa-sign-out-alt fa-2x"></i>
                               </button>
