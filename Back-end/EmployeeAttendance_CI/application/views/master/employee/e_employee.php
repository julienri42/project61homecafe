      ...
      <div class="card">
        ...
        <div class="card-body">
          <div class="row">
            ...
            <div class="col-lg-8">
              <div class="form-group">
                <label for="e_name" class="col-form-label">ชื่อ</label>
          ...
          <div class="row">
            <div class="col-lg-4">
              <div class="form-group">
                <label for="e_gender" class="col-form-label">เพศ</label>
            ...
            <div class="col-lg-4">
              <div class="form-group">
                <label for="e_birth_date" class="col-form-label">วันเกิด</label>
                <div class="col-lg p-0">
            ...
            <div class="col-lg-4">
              <div class="form-group">
                <label for="e_hire_date" class="col-form-label">วันเริ่มงาน</label>
                <div class="col-lg p-0">
          ...
          <div class="row">
            <div class="col-lg-6">
              <div class="form-group">
                <label for="s_id" class="col-form-label">เวลางาน</label>
            ...
            <div class="col-lg-6">
              <div class="form-group">
                <label for="d_id" class="col-form-label">ตำแหน่ง</label>
