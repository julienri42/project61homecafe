...
<div class="col-lg-10 p-0">
  ...
  <div class="card">
    <h5 class="card-header">เพิ่มพนักงาน</h5>
    <div class="card-body">
      <div class="row">
        <div class="col-lg-6">
          <div class="form-group row">
            <label for="e_name" class="col-form-label col-lg-4">ชื่อพนักงาน</label>
            <div class="col p-0">
          ...
          <div class="form-group row">
            <label for="d_id" class="col-form-label col-lg-4">ตำแหน่ง</label>
            <div class="col p-0">
          ...
          <div class="form-group row">
            <label for="e_gender" class="col-form-label col-lg-4">เพศ</label>
        ...
        <div class="col-lg-6">
          <div class="form-group row">
            <label for="image" class="col-form-label col-lg-4">รูป</label>
            <div class="col-lg-8 p-0">
              <input type="file" name="image" id="image">
            </div>
          </div>
          <div class="form-group row">
            <label for="s_id" class="col-form-label col-lg-4">เวลางาน</label>
            <div class="col p-0">
          ...
          <div class="form-group row">
            <label for="e_birth_date" class="col-form-label col-lg-4">วันเกิด</label>
          ...
          <div class="form-group row">
            <label for="e_hire_date" class="col-form-label col-lg-4">วันเริ่มงาน</label>
            <div class="col-lg p-0">
