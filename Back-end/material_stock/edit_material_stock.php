...
while($row = $result->fetch_array()){
                                ...
                                <tr>
                                    ...
                                    <tr id='inputunit_show'>
                                        ...
                                        <select name='material_inputunit' class='form-control' id='material_inputunit'>
                                            ...
                                            <?php 
                                                 echo '<option value="'.$row['material_usedunit'].'" > รับเข้ามาแบบ'.$row['material_usedunit'].'</option>';
                                                 if(!empty($row['material_buyunit']))
                                                 {
                                                    echo '<option value="'.$row['material_buyunit'].'"> รับเข้ามาแบบ'.$row['material_buyunit'].'</option>';
                                                 }
                            ...
                            <td><a href="#"  data-toggle="modal" data-target="#edit" class="btn btn-success mt-2">เพิ่ม</a></td>
                            <td><a href="material_stock.php" class="btn btn-danger mt-2">ยกเลิก</a></td>     
                            </center>
                            <!-- edit Modal-->
                                ...
                                <div class="modal-dialog" role="document">
                                     ...
                                     <div class="modal-body">คุณต้องการเพิ่มข้อมูลสต็อกวัตถุดิบใช่หรือไม่ ?</div>
                                        <div class="modal-footer">
                                            <input class="btn btn-success text-light"  type="submit" value="เพิ่ม">
