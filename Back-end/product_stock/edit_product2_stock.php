...
<body class="g-sidenav-show">
                    ...
                    <div class="card mb-4">
                        ...
                        <div class="card-body px-0 pt-0 pb-2">
                            ...
                            <table>
                                ...
                                <tr>
                                    <td><p class="mt-2 mb-2 mr-3 float-right" >จำนวนสต็อก: </p></td>
                                    
                                    <td><p class="mt-2 mb-2"><input type="number" id='product_stock_quantity'  name="product_stock_quantity" class="form-control" max="<?php echo $total;  ?>" value=""  placeholder='กรุณาจำนวนต่อชิ้น'></p></td>
                                    <td></td>
                                </tr>
                                <tr id='shownumtotal'>
                                    <td></td>
                                    <td class='text-danger'>คุณกรอกเกินกว่าที่จะทำได้</td>
                                </tr>
                                                    ...
                                                    <table class="table table-bordered ">
                                                        ...
                                                        <tbody>
                                                            ...
                                                            if ($product_make == "ทำเอง") {
                                                                ...
                                                                while ($row2 = $result2->fetch_array()) {
                                                                    $num++;
                                                                    $ranger=mysqli_num_rows($result2);
                                                                    ...
                                                                    echo "<td id='mat$num'>" . number_format($listmaterial_quantity, 2) . " " . $row2['material_usedunit'] . "ต่อ" . $row2['product_unit'] . "</td>";
                                                                    $material_usedunit=$row2['material_usedunit'];
                                                            ...
                                                            echo "<tr><td colspan='3'> <center>สามารถทำได้ ".floor($numtotal)." ".$row['product_unit']."</center></td></tr>";
                                                            echo "<input type ='hidden' id='numtotal' name='numtotal' value='".floor($numtotal)."'>";
                                                            echo "</tbody>";
                                                             echo "</table>";
                                                            ?>
                                </tr>
    ...
    <script>
        ...
        $('#chk').on('click', function() {
            ...
            $('#showproduct_stock_expiry_date').hide();
            $('#shownumtotal').hide(); 
            if( $('#product_stock_quantity').val() != '' && $('#product_stock_expiry_date').val() != '')
            {
                if($('#numtotal').val()>=$('#product_stock_quantity').val())
                {
