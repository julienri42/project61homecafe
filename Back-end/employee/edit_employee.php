                ...
                <div class="col-12">
                    <div class="card mb-4">
                        <div class="card-header pb-0">
                            <div class='row'>
                                <h2 class='col-6'>แก้ไขข้อมูลพนักงาน</h2>
                                    ...
                                    while ($row = mysqli_fetch_assoc($result)) {
                                        ...
                                        echo "<tr>";
                                            ...
                                            echo "<select id='employee_position' name='employee_position' class='form-select fs-4 '>";
                                                echo "<option value='' >กรุณาเลือกตำแหน่ง</option>";
                                                if($row['employee_position']=="admin")
                                                {
                                                ...
                                                else if($row['employee_position']=="พนักงาน")
                                                {
                                                    echo "<option value='admin'>admin</option>"; 
                                                    echo "<option value='พนักงาน' selected>พนักงาน</option>"; 
                                                    echo "<option value='พนักงานจัดส่ง' >พนักงานจัดส่ง</option>"; 
                                                    echo "<option value='เจ้าของร้าน' >เจ้าของร้าน</option>"; 
                                                }
                                                else if($row['employee_position']=="พนักงานจัดส่ง")
                                                {
                                                    echo "<option value='admin'>admin</option>"; 
                                                    echo "<option value='พนักงาน' >พนักงาน</option>"; 
                                                    echo "<option value='พนักงานจัดส่ง' selected>พนักงานจัดส่ง</option>"; 
                                                    echo "<option value='เจ้าของร้าน' >เจ้าของร้าน</option>"; 
                                                }
                                                else
                                                {
                                                    ...
                                                    echo "<option value='พนักงาน' >พนักงาน</option>"; 
                                                    echo "<option value='พนักงานจัดส่ง' >พนักงานจัดส่ง</option>"; 
                                                    echo "<option value='เจ้าของร้าน' selected>เจ้าของร้าน</option>"; 
                                                }
                            ...
                            <div class="modal fade" id="editModal" tabindex="-1" role="dialog" aria-labelledby="exampleModalLabel" aria-hidden="true">
                                <div class="modal-dialog" role="document">
                                    <div class="modal-content">
                                        ...
                                        <div class="modal-body">คุณต้องการบันทึกข้อมูลลูกค้า?</div>
    ...
    <script language="javascript">
        ...
        $('#chk').on('click', function() {
            ...
            if ($('#employee_password').val() != '' && $('#employee_title').val() != '' && $('#employee_firstname').val() != '' && $('#employee_surname').val() != '' &&
                ...
                $('#employee_address').val() != ''  && $('#employee_position').val() != '') {
