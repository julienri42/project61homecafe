<?php 
    ...
    else
    {
        ...
        ,employee_title='".$_POST['employee_title']."',employee_firstname='".$_POST['employee_firstname']."',employee_surname ='".$_POST['employee_surname']."'
        ,employee_tel='".$_POST['employee_tel']."',employee_email='".$_POST['employee_email']."',employee_workdate='".$_POST['employee_workdate']."'
