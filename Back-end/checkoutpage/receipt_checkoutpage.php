...
$_SESSION['page'] = "receipt_checkoutpage.php";
        ...
        <div class="col-12">
          <div class="card mb-4">
            <div class="card-header pb-0">
              <div class='row'>
                <h2 class='col-6'>ข้อมูลใบเสร็จ(พนังงาน)</h2>
              </div>
                        ...
                        <tbody>
                            ...
                            if (isset($_POST['date_from']) && !empty($_POST['date_to'])) {
                                ...
                                $sql = "SELECT * FROM tb_order as o  
                                        ...
                                        WHERE order_date_added>='$date_form' AND order_date_added<='$date_to 23:59:59' AND order_status='พนักงาน'
                            ...
                            while ($row = $result->fetch_array()) {
                                ...
                                echo "<td> $numitem </td>";
                                echo "<td>" . $row['order_total'] . " บาท</td>";
                                echo "<td>" . $row['employee_firstname'] . "</td>";
                            ?>
                                <td><a href="#" onClick="window.open('report_checkoutpage2.php?id=<?php echo $row['order_id']; ?>','','width=650,height=600,top=100,left=500'); return false;" class="text-success">รายละเอียด</a></td>
                                <?php
