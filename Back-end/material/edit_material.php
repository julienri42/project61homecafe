...
<body class="g-sidenav-show">
                ...
                <div class="col-12">
                    <div class="card mb-4">
                        <div class="card-header pb-0">
                            <div class='row'>
                                <h2 class='col-6'>แก้ไขข้อมูลวัตถุดิบ</h2>
                            </div>
                        </div>
                        <div class="card-body px-0 pt-0 pb-2">
                            <!-- เนื้อหา -->
                            <center>
                                <form action='edit_material_ck.php' method='post' enctype='multipart/form-data'>
                                    <?php
                                    echo "<hr class='bg-dark'>";
                                    $material_id = $_GET['id'];
                                    $sql = "SELECT * FROM tb_material_list  WHERE material_id='$material_id'";
                                    ...
                                    echo "<td class=''><p class=' fs-4 text-dark col-6'><input type='text' id='material_name' value='".$row['material_name']."' class='form-control fs-4'  name='material_name' placeholder='กรุณากรอกชื่อวัตถุดิบ'></p></td>";
                                    echo "</tr>";
                                    ...
                                    while ($row2 = mysqli_fetch_assoc($result2)) {
                                        if($row['typematerial_id']==$row2['typematerial_id'])
                                        {
                                            echo "<option value='".$row2['typematerial_id']."' selected>".$row2['typematerial_name']."</option>";
                                        }
                                        else
                                        {
                                    ...
                                    echo "<td ><p class='fs-4 text-dark col-6'> <textarea id='material_description'  name='material_description' rows='4' cols='50' class='form-control  fs-4' placeholder='กรุณากรอกรายละเอียด' >".$row['material_description']."</textarea></p></td>";
                                    echo "</tr>";
                                    ...
                                    echo "<option value='' >กรุณาเลือกหน่วยที่ใช้ในวัตถุดิบ</option>";
                                    if($row['material_usedunit']=="กรัม")
                                    {
                                        echo "<option value='กรัม' selected>กรัม</option>";
                                        echo "<option value='ชิ้น'>ชิ้น</option>";
                                        echo "<option value='ฟอง'>ฟอง</option>";
                                        echo "<option value='อื่นๆ' >อื่นๆ</option>";
                                    }
                                    else if($row['material_usedunit']=="ชิ้น")
                                    {
                                    ...
                                    else if($row['material_usedunit']=="ฟอง"){
                                        echo "<option value='กรัม'>กรัม</option>";
                                        echo "<option value='ชิ้น'>ชิ้น</option>";
                                        echo "<option value='ฟอง' selected>ฟอง</option>";
                                        echo "<option value='อื่นๆ' >อื่นๆ</option>";
                                    }
                                    else{
                                        echo "<option value='กรัม'>กรัม</option>";
                                    ...
                                    echo "</p></td>";
                                    ///
                                    if($row['material_usedunit']!="กรัม"&& $row['material_usedunit']!="ชิ้น" && $row['material_usedunit']!="ฟอง")
                                    {
                                        echo "</tr>";
                                        echo "<tr  id='typeusedunit'>";
                                        echo "<td ><p class='p-3 fs-4 text-dark text-end'>เขียนหน่วยที่ใช้ในวัตถุดิบ :</p></td>";
                                        echo "<td ><p class='fs-4 text-dark col-6'> <input type='text' name='otherusedunit' class='form-control' value='".$row['material_usedunit']."'></td>";
                                        echo "</tr>";
                                    }
                                    else
                                    {
                                        ...
                                        echo "<tr  id='typeusedunit'>";
                                        echo "<td ><p class='p-3 fs-4 text-dark text-end'>เขียนหน่วยที่ใช้ในวัตถุดิบ :</p></td>";
                                        echo "<td ><p class='fs-4 text-dark col-6'> <input type='text' name='otherusedunit' class='form-control'></td>";
                                        echo "</tr>";
                                    }
                                    ...
                                    echo "<tr class=''>";
                                    echo "<td class=''><p class='p-3 fs-4 text-dark text-end'>หน่วยที่รับมา :</p></td>";
                                    echo "<td class=''><p class=' fs-4 text-dark col-6'>";
                                    echo "<select name='material_buyunit'  class='form-select fs-5' id='material_buyunit'>";
                                    echo "<option value='' >กรุณาเลือกหน่วยที่รับมา</option>";
                                    if($row['material_buyunit']=="ถุง")
                                    {
                                    ...
                                    else if($row['material_buyunit']=="แผง")
                                    {
                                        echo "<option value='ถุง'>ถุง</option>";
                                        echo "<option value='แผง' selected>แผง</option>";
                                        echo "<option value='โหล'>โหล</option>";
                                        echo "<option value='อื่นๆ' >อื่นๆ</option>";
                                    }
                                    else if($row['material_buyunit']=="โหล"){
                                        echo "<option value='ถุง'>ถุง</option>";
                                        echo "<option value='แผง'>แผง</option>";
                                        echo "<option value='โหล' selected>โหล</option>";
                                        echo "<option value='อื่นๆ' >อื่นๆ</option>";
                                    }
                                    else{
                                        echo "<option value='ถุง'>ถุง</option>";
                                    ...
                                    echo "</p></td>";
                                    echo "</tr>";
                                    if($row['material_buyunit']!="ถุง"&& $row['material_buyunit']!="แผง" && $row['material_buyunit']!="โหล")
                                    {
                                        echo "<tr  id='typebuyunit'>";
                                        echo "<td ><p class='p-3 fs-4 text-dark text-end'>เขียนหน่วยที่รับมา :</p></td>";
                                        echo "<td ><p class='fs-4 text-dark col-6'> <input type='text' name='otherbuyunit' class='form-control fs-4' value='".$row['material_buyunit']."'></td>";
                                        echo "</tr>";
                                    }
                                    else
                                    {
                                        echo "<tr  id='typebuyunit'>";
                                        echo "<td ><p class='p-3 fs-4 text-dark text-end'>เขียนหน่วยที่รับมา :</p></td>";
                                        echo "<td ><p class='fs-4 text-dark col-6'> <input type='text' name='otherbuyunit' class='form-control'></td>";
                                        echo "</tr>";
                                    }
                                    ...
                                    echo "<td class=''><p class=' fs-4 text-dark col-6'><input  id='material_buyconversionused' value='".$row['material_buyconversionused']."' class='form-control fs-4' type='text' placeholder='กรุณากรอกจำนวน' name='material_buyconversionused' ></p></td>";
                                    echo "</tr>";
                            ...
                            <div class="modal fade" id="editModal" tabindex="-1" role="dialog" aria-labelledby="exampleModalLabel" aria-hidden="true">
                                <div class="modal-dialog" role="document">
                                    <div class="modal-content">
                                        ...
                                        <div class="modal-body">คุณต้องการบันทึกข้อมูลวัตถุดิบ?</div>
    ...
    <script>
        // แก้ไขส่วนนี้เข้าไปจะถือว่าเป็นการตั้งค่าให้ Datatable เป็น Default ใหม่เลย
    ...
    <script>
        ...
        if($('#material_usedunit').val()=="อื่นๆ")
        {
            $('#typeusedunit').show();
        }
        else{
