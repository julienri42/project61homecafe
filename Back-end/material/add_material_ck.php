<?php 
    ...
    &&isset($_POST['material_description'])&&$_POST['material_usedunit']!='0')
    {
            ...
            $material_date_created=date("Y-m-d H:i:s",time());
            $material_date_updated=date("Y-m-d H:i:s",time());
            $sql ="INSERT INTO tb_material_list(material_name,typematerial_id,material_description
            ,material_date_created,material_date_updated,material_usedunit,material_buyunit,material_buyconversionused)
            VALUES('$material_name','$typematerial_id','$material_description','$material_date_created','$material_date_updated'
            ,'$material_usedunit','$material_buyunit','$material_buyconversionused')";
