...
$_SESSION['page'] = "receipt_online.php";
        ...
        <div class="col-12">
          <div class="card mb-4">
            <div class="card-header pb-0">
              <div class='row'>
                <h2 class='col-6'>ออกใบเสร็จ(สมาชิก)</h2>
              </div>
                ...
                if (isset($_SESSION['edit_status'])) {
                    if ($_SESSION['edit_status'] == "3") {
                        echo '<div class="alert alert-success alert-dismissible fade show" role="alert">
                                        <h5 class="alert-heading">ลบข้อมูลใบเสร็จสำเร็จ</h5>
                    ...
                    if ($_SESSION['edit_status'] == "2") {
                        echo '<div class="alert alert-success alert-dismissible fade show" role="alert">
                                        <h5 class="alert-heading">ยกเลิกข้อมูลใบเสร็จสำเร็จ</h5>
                                          <button type="button" class="close" data-dismiss="alert" aria-label="Close">
                                            <span aria-hidden="true">&times;</span>
                                          </button>
                                        </div>';
                            ...
                            <tbody>
                                ...
                                if (isset($_POST['date_from'])) {
                                    ...
                                    $sql = "SELECT * FROM tb_order as o  
                                            ...
                                            WHERE order_date_added>='$date_form' AND  order_status!='รอการชำระเงิน' AND order_status!='การสั่งซื้อหมดอายุ' AND order_status!='พนักงาน'
                                            ORDER BY order_receipt_no DESC";
                                } else {
                                    $sql = "SELECT * FROM tb_order as o  
                                            INNER JOIN tb_employee AS e ON o.employee_id=e.employee_id
                                            WHERE order_status!='รอการชำระเงิน' AND order_status!='การสั่งซื้อหมดอายุ' AND order_status!='พนักงาน'
                                            ORDER BY order_receipt_no DESC";
                                }
                                ...
                                ?>
                                    <td><a href="#" onClick="window.open('receipt_online_detail.php?id=<?php echo $row['order_id']; ?>','','width=650,height=600,top=100,left=500'); return false;" class="text-success">รายละเอียด</a></td>
