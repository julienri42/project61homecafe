                ...
                if (isset($_SESSION['edit_status'])) {
                    if ($_SESSION['edit_status'] == "4") {
                        echo '<div class="alert alert-success alert-dismissible fade show" role="alert">
                                        <h5 class="alert-heading">นำเสริฟแก่ลูกค้าเสร็จ</h5>
                                         
                                        </div>';
                    }
                    if ($_SESSION['edit_status'] == "2") {
                        echo '<div class="alert alert-danger alert-dismissible fade show" role="alert">
                                        <h5 class="alert-heading">ยกเลิกการนำเสริฟแก่ลูกค้าสำเร็จ</h5>
                ...
                <thead class="thead-pink">
                            ...
                            <tbody>
                                <?php
                                  ...
                                  WHERE order_status='รออาหารสักครู่' AND order_service_id='$employee_id'
                                ...
                                while ($row = $result->fetch_array()) {
                                    ...
                                    echo "<td ><a href='service_shopping_detail.php?id=".$row['order_id']."' class='text-success'> รายละเอียด</a></td>";
