...
$_SESSION['page'] = "service_input.php";
        ...
        <div class="col-12">
          <div class="card mb-4">
            <div class="card-header pb-0">
              <div class='row'>
                <h2 class='col-6'>นำเสริฟแก่ลูกค้า</h2>
                 ...
                 if (isset($_SESSION['edit_status'])) {
                        if ($_SESSION['edit_status'] == "4") {
                            echo '<div class="alert alert-success alert-dismissible fade show" role="alert">
                                            <h5 class="alert-heading">นำเสริฟแก่ลูกค้าสำเร็จ</h5>
                                            </div>';
                        }
                        if ($_SESSION['edit_status'] == "3") {
                            echo '<div class="alert alert-danger alert-dismissible fade show" role="alert">
                                            <h5 class="alert-heading">นำเสริฟแก่ลูกค้าล้มเหลว</h5>
                                            </div>';
                        }
                ...
                <thead class="thead-pink">
                            ...
                            <tbody>
                                <?php
                                  ...
                                  WHERE order_status='รออาหารสักครู่'AND order_service_id=''
                                ...
                                while ($row = $result->fetch_array()) {
                                    ...
                                    echo "<td><a href='#' data-toggle='modal' data-target='#editModal".$row['order_id']."' class='btn btn-primary'>นำเสริฟแก่ลูกค้า</a></td>";
                                    echo ' <div class="modal fade" id="editModal'.$row['order_id'].'" tabindex="-1" role="dialog" aria-labelledby="exampleModalLabel"
                                    aria-hidden="true">
                                    <div class="modal-dialog" role="document">
                                        <div class="modal-content">
                                            <div class="modal-header">
                                                <h5 class="modal-title" id="exampleModalLabel">นำเสริฟแก่ลูกค้า </h5>
                                                <button class="close" type="button" data-dismiss="modal" aria-label="Close">
                                                    <span aria-hidden="true">×</span>
                                                </button>
                                            </div>
                                            <div class="modal-body">คุณต้องการนำเสริฟแก่ลูกค้า ใช่หรือไม่ ?</div>
                                            <div class="modal-footer">
                                                <a class="btn btn-primary text-light" href="service_input_detail.php?id='.$row['order_id'].'">นำเสริฟแก่ลูกค้า</a>
