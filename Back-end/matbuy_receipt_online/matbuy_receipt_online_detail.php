...
<head>
    ...
    <title>รายงานซื้อของเข้าร้าน</title>
            ...
            <div id="outprint_receipt">
                ...
                ?>
                    ...
                    <div class="fs-6 fs-light d-flex w-100 mb-1">
                        <span class="col-auto pe-2">สถานะซื้อของเข้าร้าน:</span>
                        <?php
                        if ($row['matbuy_status'] == "รอซื้อของเข้าร้าน") {
                   ...
                   <br>
                    ...
                    <br>
                        ผู้ที่ซื้อของเข้าร้าน
                    <br><br>
                    วันที่ซื้อของเข้าร้าน : <?php echo DateThai($row['matbuy_date_added']); ?>
                    <br><br>
                </div>
                    <br><br>
