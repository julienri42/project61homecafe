                ...
                <div class="col-12">
                    <div class="card mb-4">
                        ...
                        <div class="card-body px-0 pt-0 pb-2">
                            <!-- เนื้อหา -->
                            <center>
                                <form action='add_product_ck.php' method='post' enctype='multipart/form-data'>
                                    <?php
                                    ...
                                    echo "<td class=''><p class=' fs-4 text-dark col-6'><input type='text' id='product_name' class='form-control fs-4'  name='product_name' placeholder='กรุณากรอกชื่อสินค้า'></p></td>";
                                    echo "</tr>";
                                    ...
                                    echo "<option value='' selected>กรุณาประเภทสินค้า</option>";
                                    ...
                                    echo "<td ><p class='fs-4 text-dark col-6'> <textarea id='product_description'  name='product_description' rows='4' cols='50' class='form-control  fs-4' placeholder='กรุณากรอกรายละเอียด' ></textarea></p></td>";
                                    echo "</tr>";
                                    ...
                                    echo "<td class=''><p class=' fs-4 text-dark col-6'><input  id='product_price' class='form-control fs-4' type='number' placeholder='กรุณากรอกราคาสินค้า' name='product_price' ></p></td>";
                                    echo "</tr>";
                                    ...
                                    echo "<option value='' selected>กรุณาเลือกหน่วย</option>";
                                    ...
                                    echo "<option value='แก้ว' >แก้ว</option>";
                                    ...
                                    echo "<td ><p class='fs-4 text-dark col-6'> <input type='text' name='otherunit' class='form-control fs-4'></td>";
                                    echo "</tr>";
                                    ...
                                    echo "<option value='' selected>กรุณาเลือกรูปแบบสินค้า</option>";
                            ...
                            <div class="modal fade" id="editModal" tabindex="-1" role="dialog" aria-labelledby="exampleModalLabel" aria-hidden="true">
                                <div class="modal-dialog" role="document">
                                    <div class="modal-content">
                                        ...
                                        <div class="modal-body">คุณต้องการเพิ่มข้อมูลสินค้า?</div>
