...
if(isset($_GET['mid']))
    ...
    if(isset($_GET['id']))
    {
        ...
        $sql="SELECT * FROM tb_listmaterial_to_product WHERE product_id='".$_SESSION["product_id"]."'";
        $result = $connect->query($sql);
        while($row = $result->fetch_array())
        {
            $_SESSION['mid'][]=$row['material_id'];
            $_SESSION['amount'][]=$row['listmaterial_quantity'];
        }
    }
?>
<!DOCTYPE html>
                ...
                <div class="col-12">
                    ...
                    <div class="row">
                                ...
                                <table class="table table-bordered " cellspacing="0">
                                    ...
                                    <tbody>
                                        ...
                                        while ($row = $result->fetch_array()) {
                                            ...
                                            echo "<tr>";
                                            echo " <form action='edit_product2_detail.php' method='GET'>";
                                            ...
                                            echo "<td><input type='submit' value='เพิ่มวัตถุดิบ' class='btn btn-success'></td>";
                                            echo " </form>";
                                            echo "</tr>";
                                        }
                                        ?>
                        ...
                        <div class="col-6">
                            ...
                            <form action="edit_product2_ck.php" method="POST">
                                <div class="table-responsive">
                                            ...
                                            if (!empty($_SESSION['mid'])) {
                                                for ($i = 0; $i < count($_SESSION['mid']); $i++) {
                                                    ...
                                                    while ($row = $result->fetch_array()) {
                                                        ...
                                                        echo "<input type='hidden' name='mid[]' value='" . $row['material_id'] . "'>";
                                                        echo "<td> <a href='edit_product2_detail.php?delete=" . $row['material_id'] . "&deleteamount=" . $i . "' class='btn btn-success'>ลบวัตถุดิบ</a></td>";
                                                        echo "</tr>";
                                                    }
                                                }
                                            } else {
                                    ...
                                    <center>
                                        <br>
                                        <br>
                                                <a href="#"  data-toggle="modal" data-target="#add" class="btn btn-primary">แก้ไขรายละเอียดข้อมูลวัตถุดิบ</a>
                                                <div class="modal fade" id="add" tabindex="-1" role="dialog" aria-labelledby="exampleModalLabel"
                                                aria-hidden="true">
                                                    <div class="modal-dialog" role="document">
                                                        <div class="modal-content">
                                                             <div class="modal-header">
                                                                <h5 class="modal-title" id="exampleModalLabel">แก้ไขรายละเอียดข้อมูลวัตถุดิบ</h5>
                                                                 <button class="close" type="button" data-dismiss="modal" aria-label="Close">
                                                                    <span aria-hidden="true">×</span>
                                                                 </button>
                                                            </div>
                                                            <div class="modal-body">คุณต้องการแก้ไขรายละเอียดข้อมูลวัตถุดิบ ใช่หรือไม่ ?</div>
                                                                <div class="modal-footer">
                                                                    <input class="btn btn-primary text-light"  type="submit" value="แก้ไข">
                                                                    <button class="btn btn-secondary" type="button" data-dismiss="modal">ยกเลิก</button>
                                                                </div>
                                                            </div>
                                                        </div>
                                                    </div>  
                                                <a href="product.php" class="btn btn-danger">ไม่แก้ไขวัตถุดิบที่ใช้ในการทำสินค้า</a>
                                    </center>
                                </div>
