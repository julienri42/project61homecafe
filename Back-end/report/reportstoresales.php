...
$_SESSION['page'] = "reportstoresales.php";
                ...
                <div class="col-12">
                    <div class="card mb-4">
                        <div class="card-header pb-0">
                            <div class='row'>
                                <h2 class='col-6'>สารสนเทศยอดขาย(พนักงาน)</h2>
                            </div>
                        ...
                        <div class="card-body px-0 pt-0 pb-2">
                            ...
                            <center>
                                ...
                                ?>
                                <form action="reportstoresales.php" method="POST">
                                    <div class="row m-2">
                                        ...
                                        <div class="form-group col-md-4 text-start mt-1">
                                            ...
                                            ?>
                                            <a class="btn btn-success rounded-0" onClick="window.open('printstoresales.php?id=<?php echo $date_form; ?>','','width=1200,height=800,top=100,left=200'); return false;"><i class="fa fa-print"></i> ปริ้นสารสนเทศ</a>
                                        </div>
                                    </div>
                                </form>
                                <hr class='bg-dark'>
                            ...
                            WHERE order_status = 'พนักงาน' AND order_date_added LIKE '$date_form%'";
                                                            } else {
                                                                $sql = "SELECT 	sum(order_total-order_discount) FROM tb_order
                            ...
                            GROUP BY b.product_id ORDER BY sum(orderdetail_quantity) DESC LIMIT 1 ";
                                ...
                                <div class="table-responsive p-3">
                                    ...
                                    ";
                                            ...
                                            ?>
                                                    <td><a href="#" onClick="window.open('reportstoresales_detail.php?id=<?php echo $row['order_id']; ?>','','width=1200,height=700,top=200,left=200'); return false;" class="text-success">รายละเอียด</a></td>
                                            <?php
