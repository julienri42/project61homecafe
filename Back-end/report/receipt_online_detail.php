            ...
            <div id="outprint_receipt">
                ...
                ?>
                    <div class="text-center fw-bold lh-1 border-top border-bottom border-dark">
                        ...
                        <small>61 home cafa</small><br>
                        <small>ที่ตั้ง 79 หมู่ 1 ตำบล สุเทพ อำเภอ เมือง จังหวัด เชียงใหม่ 50200</small><br>
                        <small>โทร. 088-025-2056 เลขประจำตัวผู้เสียภาษีอากร 0 8035 28000 989</small>
                        <br>
                        <br>
                    </div>
                    ...
                    <div class='text-center fw-bold lh-1 border-top border-bottom border-dark'>
                        <br>
                        <span class="border-bottom border-dark"><?php echo $row['employee_firstname'] . " " . $row['employee_surname']  ?></span>
                        <br><br>
                        ผู้รับเงิน
                        <br><br>
