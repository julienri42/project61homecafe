                ...
                <div class="col-12">
                    <div class="card mb-4">
                        ...
                        <div class="card-body px-0 pt-0 pb-2">
                            <!-- เนื้อหา -->
                            <center>
                                <form action='add_typeproduct_ck.php' method='post' enctype='multipart/form-data'>
                                    <?php
                                    ...
                                    echo "<td class=''><p class='fs-4 text-dark col-12'><input type='text' id='typeproduct_name' class='form-control fs-4'  name='typeproduct_name' placeholder='กรุณากรอกชื่อประเภทสินค้า'></p></td>";
                                    echo "</tr>";
                            ...
                            <div class="modal fade" id="editModal" tabindex="-1" role="dialog" aria-labelledby="exampleModalLabel" aria-hidden="true">
                                <div class="modal-dialog" role="document">
                                    <div class="modal-content">
                                        ...
                                        <div class="modal-body">คุณต้องการเพิ่มข้อมูลประเภทสินค้า?</div>
