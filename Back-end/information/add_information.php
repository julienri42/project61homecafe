...
<body class="g-sidenav-show">
                ...
                <div class="col-12">
                    <div class="card mb-4">
                        ...
                        <div class="card-body px-0 pt-0 pb-2">
                            <!-- เนื้อหา -->
                            <center>
                                <form action='add_information_ck.php' method='post' enctype='multipart/form-data'>
                                    <?php
                                    ...
                                    echo "<td class=''><p class=' fs-4 text-dark col-6'><input type='text' id='information_name' class='form-control fs-4'  name='information_name' placeholder='กรุณากรอกชื่อข่าวสาร'></p></td>";
                                    echo "</tr>";
                                    ...
                                    echo "<td ><p class='fs-4 text-dark col-6'> <textarea id='information_details'  name='information_details' rows='4' cols='50' class='form-control  fs-4' placeholder='กรุณากรอกรายละเอียด' ></textarea></p></td>";
                                    echo "</tr>";
                                    ...
                                    // echo " <td><p class='mt-1 mb-1'><input type='date' id='information_date' name='information_date' class='form-control' ></p></td>";
                                    // echo "</tr>";
                                ...
                                <div class="modal-dialog" role="document">
                                    <div class="modal-content">
                                        <div class="modal-header">
                                            <h5 class="modal-title" id="exampleModalLabel">เพิ่มข้อมูลข่าวสาร</h5>
                                        </div>
                                        <div class="modal-body">คุณต้องการเพิ่มข้อมูลข่าวสาร?</div>
    ...
    <script>
        ...
        $('#chk').on('click', function() {
            $('#showinformation_name').hide(); 
        $('#showinformation_details').hide();
            if ($('#information_name').val() != '' &&  $('#information_details').val() != '' ) {
