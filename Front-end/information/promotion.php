  ...
  <!-- <div class="w3-top">
    <div class="w3-bar w3-white w3-padding w3-card">
      ...
      <!-- <div class="w3-left w3-hide-small">
        ...
        <a href="#" class="w3-bar-item w3-button">โปรโมชั่น</a>
      </div>
  ...
  <div class="navbar ">
      <div class="container ">
        ...
        <div class="navbar__links ">
          ...
          <a href="information.php" class="navbar__link w3-bar-item w3-button">ข่าวสารประชาสัมพันธ์</a>
          <a href="#" class="navbar__link w3-bar-item w3-button">โปรโมชั่น</a>
      ...
      <header class="bg-secondary py-5  ">
        <div class="container pt-5">
            <div class="text-center text-white">
                ...
                <h1 class="display-4 fw-bolder">61Homecafe โปรโมชั่น</h1>
                <p class="lead fw-normal text-white-50 mb-0">โปรโมชั่นมาแล้ววันนี้</p>
            </div>
        </div>
    </header>
    <!-- Section-->
    <section class="py-5">
        <div class="container px-4 px-lg-5 mt-5">
            <div class="row gx-4 gx-lg-5 row-cols-2 row-cols-md-3 row-cols-xl-3 justify-content-center items">
                ...
                <!--เปิด-->
                <?php
                $sql = "SELECT * FROM promotions WHERE promotion_delete='0'";
                ...
                ?>
                        ...
                        <div class="col mb-5 ">
                            <div class="card h-100 hover">
                                ...
                                <?php
                                echo "<a href='detail_page_promotion.php?proid=".$row['promotion_id']."'>";
                                if (!empty($row['promotion_img'])) {
                                    echo "<img class='card-img-top1' src='../../assets/img/promotion/" . $row['promotion_img'] . "'   alt='item1'/>";
                                } else {
                                    echo "<img class='card-img-top1' src='../../assets/img/promotion/nopromotion.png' alt='item1' />";
                                }
                                ?>
                                ...
                                <div class="card-body p-4">
                                    <div class="text-center">
                                        <!-- Product name-->
                                        <h5 class="fw-bolder"><?php echo $row['promotion_name'];  ?></h5>
                                         <!-- Product price-->
