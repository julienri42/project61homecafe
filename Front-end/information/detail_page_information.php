...
<div class="w3-top">
    ...
    <section class="py-5 ">
        <div class="container px-4 px-lg-5 mt-5">
            ...
            <!--เปิด-->
            <?php
            $sql = "SELECT * FROM informations WHERE information_id='$proid'";
                        ...
                        <div class="row gx-4 gx-lg-5 align-items-center ">
                            <div class="col-md-6">
                                ...
                                if (!empty($row['information_img'])) {
                                    echo "<img class='card-img-top mb-5 mb-md-0 item1' src='../../assets/img/information/" . $row['information_img'] . "'   />";
                                } else {
                                    echo "<img class='card-img-top mb-5 mb-md-0' src='../../assets/img/information/noinformation.png'  />";
                                }
                                ?>
                            </div>
                            <div class="col-md-6">

                                <h1 class="display-5 fw-bolder"><?php echo $row['information_name'];  ?></h1>
                                <div class="fs-5 mb-5">
                                    <!-- <span> <?php echo " <div id='price'>฿" . $row['product_price'] . "</div>"; ?> </span>
                                    <?php echo "<input type='hidden' id='price0' value='" . $row['product_price'] . "'>";  ?> -->
                                </div>
                                <p class="lead">รายละเอียดข่าวสาร : <?php echo $row['information_details']; ?></p>
